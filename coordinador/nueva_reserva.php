...
$fechaPre = $_GET['fecha'] ?? '';
$espacioPre = $_GET['espacio_id'] ?? '';
$horaInicioPre = $_GET['hora_inicio'] ?? '';
$horaFinPre = $_GET['hora_fin'] ?? '';
...
$opcionesLicenciaturas = '<option value="">Seleccione</option>';
foreach ($licenciaturasCoordinador as $lic) {
    $opcionesLicenciaturas .= '<option value="' . htmlspecialchars($lic, ENT_QUOTES) . '">' . htmlspecialchars($lic) . '</option>';
}
        ...
        <form action="guardar_reserva.php" method="POST">
            ...
            <div class="grid-form">
                <div>
                    ...
                    <input type="text" name="folio_coordinador" required>
                </div>
                ...
                <div>
                    ...
                    <select name="tipo_actividad" required>
                        ...
                        <option value="Actividades ludicas o recreativas">Actividades ludicas o recreativas</option>
            ...
            <div class="seccion-espacios">
                ...
                <div id="contenedor-detalles">
                    <div class="detalle-item" data-indice="0">
                        <div class="titulo-bloque">Espacio 1</div>
                        ...
                        <div class="grid-form">
                            <div>
                                ...
                                <select name="espacio_id[]" required>
                                    <option value="">Seleccione</option>
                                    <?php
                                    $espacios = $conexion->query("SELECT * FROM espacios WHERE estatus='disponible' ORDER BY nombre ASC");
                                    while($e = $espacios->fetch_assoc()){
                                        $selected = ($espacioPre !== '' && $espacioPre == $e['id']) ? 'selected' : '';
                                    ?>
                            ...
                            <div>
                                ...
                                <input
                                    type="date"
                                    name="fecha[]"
                                    value="<?php echo htmlspecialchars($fechaPre); ?>"
                            ...
                            <div>
                                ...
                                <input type="time" name="hora_inicio[]" value="<?php echo htmlspecialchars($horaInicioPre); ?>" required>
                            </div>

                            <div>
                                <label>Hora fin</label>
                                <input type="time" name="hora_fin[]" value="<?php echo htmlspecialchars($horaFinPre); ?>" required>
                            </div>
            ...
            <div class="grid-form">
                ...
                <div>
                    ...
                    <input type="text" name="docente_responsable" required>
                </div>

                <div class="grid-full">
                    <label>Coordinador responsable</label>
                    <input type="text" name="coordinador_responsable" required>
                </div>
                    ...
                    <div class="pares-lic-cuat" id="pares-lic-cuat-general">
                        <div class="par-lic-cuat">
                            <div>
                                ...
                                <select name="lic_cuat[0][licenciatura]" required <?php echo count($licenciaturasCoordinador) === 0 ? 'disabled' : ''; ?>>
                                    <?php echo $opcionesLicenciaturas; ?>
                                </select>
                            </div>

                            <div>
                                <label>Cuatrimestre / Grupo</label>
                                <select name="lic_cuat[0][cuatrimestre]" required>
                                    <?php echo $opcionesCuatrimestres; ?>
                                </select>
                            </div>
                ...
                <div>
                    ...
                    <input type="number" name="cantidad_alumnos_general" min="1" required>
                </div>

                <div>
                    <label>Costo por alumno</label>
                    <input type="number" step="0.01" name="costo_alumno_general">
                </div>
                ...
                <div class="grid-full">
                    ...
                    <textarea name="descripcion_actividad_general"></textarea>
                </div>

                <div class="grid-full">
                    <label>Observaciones</label>
                    <textarea name="observaciones_general"></textarea>
                </div>
            </div>
